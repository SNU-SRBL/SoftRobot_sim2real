...
class SOFA_GL_COMPONENT_SHADER_API OglShader : public core::visual::Shader, public core::visual::VisualModel
{
public:
...
class SOFA_GL_COMPONENT_SHADER_API OglShaderElement : public core::visual::ShaderElement
{
protected:
