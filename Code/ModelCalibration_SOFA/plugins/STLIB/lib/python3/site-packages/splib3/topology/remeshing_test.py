...
class Remeshing_test(unittest.TestCase):
    ...
    def test_new_idx_from_conv_tab(self):
        ...
        new_mesh = mf.new_idx_from_conv_tab(mesh = mesh_test,conv_tab = conv_tab_test )
    ...
    def test_quad_2_triangles(self) :
        ...
        if triangles_from_quads != triangles :
            print("- Passage de quads à triangles faux -")
    ...
    def test_reindex_mesh(self):
        ...
        new_quads = mf.reindex_mesh(ind_tab=conv_tab,mesh=quads)
        ...
        new_triangles = mf.reindex_mesh(ind_tab=conv_tab,mesh=triangles)
    ...
    def test_remesh_from_axis(self):
        ...
        new_quads = mf.reindex_mesh(ind_tab=new_conv_tab,mesh=quads)

        if new_points != new_points_from_x :
            print("- Erreur - Reordonnation des points celon x différent #001")
        ...
        new_quads_d = mf.reindex_mesh(ind_tab=new_conv_tab_d,mesh=new_quads)

        if new_points_d != new_points_from_x_d :
            print("- Erreur - Reordonnation des points celon x différent #005")
    ...
    def test_ordering_circle(self):
        ...
        with self.assertRaises(AssertionError):
            mf.ordering_circle(cercle01,indices01,x_ref=8)
    ...
    def test_shift_tab(self): # pour décaler tous les éléments d'un tableau de 1, pour pouvoir placer les ressorts
    ...
    def test_closeSurface(self):
        ...
        if triangles != triangles_sol :
            print("- Erreur - Décalage des éléments du tableau faux - #028")
        ...
        if triangles != triangles_sol :
            print("- Erreur - Décalage des éléments du tableau faux - #029")
        self.assertEqual(triangles, triangles_sol)
        ...
        if triangles != triangles_sol :
            print("- Erreur - Décalage des éléments du tableau faux - #030")
        self.assertEqual(triangles, triangles_sol)
